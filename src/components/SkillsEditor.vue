<template>
  <div class="space-y-8">
    <section
      v-for="(skillCategory, categoryIndex) in localSkills"
      :key="categoryIndex"
    ...
    >
      ...
      <div>
        <label
          :for="'skill-category-title-' + categoryIndex"
          class="text-sm font-semibold text-gray-700"
          >Skill Category Title</label
        >
        <input
        ...
        <button
          ...
          :id="'remove-skill-category-' + categoryIndex"
      ...
      <ul class="space-y-4">
        ...
        >
          ...
          <button
            ...
            :id="'remove-skill-' + categoryIndex + '-' + skillIndex"
          ...
          <div>
            <label
              :for="'skill-name-' + categoryIndex + '-' + skillIndex"
              class="text-sm font-semibold text-gray-700"
              >Skill Name</label
            >
            <textarea
          ...
          <div>
            <label
              :for="'skill-rating-' + categoryIndex + '-' + skillIndex"
              class="text-sm font-semibold text-gray-700"
              >Skill Rating</label
            >
            <input
          ...
          <button
            v-if="skillIndex == 0"
            type="button"
            @click="splitSkill(skillCategory)"
            :id="'split-skill-' + categoryIndex"
            :aria-label="'Split skills in ' + skillCategory.title"
    ...
    <button
      ...
      aria-label="Add a new skill category"
